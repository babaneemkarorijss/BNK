...
export default function ZodiacWheel() {
  return (
    <div className="zodiac-container flex flex-wrap justify-center gap-6 py-8">
      {zodiacs.map(z => (
        <Link key={z.sign} href={`/horoscope/${z.sign}`} className="zodiac-card w-24 h-24 md:w-32 md:h-32 rounded-full bg-white shadow-lg overflow-hidden border-2 border-divine-saffron/30">
          <Image
