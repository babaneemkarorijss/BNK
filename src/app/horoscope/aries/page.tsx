...
export const metadata: Metadata = {
  ...
  description: 'Your Aries (मेष) Vedic horoscope for today – detailed guidance on education, love, career, health, finance, family, and remedies.',
};

// ─── COMPLETE 3‑DAY FALLBACK DATA FOR Aries ──────────────────
  ...
  return (
    <main className="max-w-4xl mx-auto py-16 px-4 space-y-12">
      <section className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600">मेष Rashi</p>
...
function HoroscopeContent({ sign }: { sign: string }) {
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Header */}
      <div className="divine-card text-center">
        <h2 className="text-3xl md:text-4xl font-serif text-sacred-red mb-4">Aries Horoscope</h2>
