...
export const metadata: Metadata = {
  ...
  description: 'Your Taurus (Vrishabh) Vedic horoscope for today. Consult our astrologers.',
};
  ...
  return (
    <main className="max-w-4xl mx-auto py-16 px-4 space-y-12">
      <section className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600">वृषभ राशि – Vrishabh Rashi</p>
      ...
      <section className="divine-card space-y-4">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li><strong>Ruling Planet:</strong> Venus (Shukra)</li>
          <li><strong>Element:</strong> Earth</li>
          <li><strong>Quality:</strong> Fixed (Sthira)</li>
          <li><strong>Lucky Colour:</strong> White / Pink</li>
          <li><strong>Lucky Number:</strong> 6</li>
        </ul>
      </section>
