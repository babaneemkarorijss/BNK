...
export const metadata: Metadata = {
  ...
  description: 'Your Aquarius (कुम्भ) Vedic horoscope for today – detailed guidance on education, love, career, health, finance, family, and remedies.',
};

// ─── COMPLETE 3‑DAY FALLBACK DATA FOR Aquarius ──────────────────
  ...
  return (
    <main className="max-w-4xl mx-auto py-16 px-4 space-y-12">
      <section className="text-center space-y-4">
        <h1 className="text-5xl md:text-6xl font-serif text-sacred-red">Aquarius Horoscope</h1>
        <p className="text-lg text-gray-600">कुम्भ Rashi</p>
        <div className="flex justify-center">
          <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-divine-saffron shadow-2xl hover:scale-110 transition-transform duration-500">
            <Image
              src="/assets/images/zodiac-aquarius.webp"
              alt="Aquarius"
              fill
      ...
      <HoroscopeContent sign="aquarius" />
...
function HoroscopeContent({ sign }: { sign: string }) {
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Header */}
      <div className="divine-card text-center">
        <h2 className="text-3xl md:text-4xl font-serif text-sacred-red mb-4">Aquarius Horoscope</h2>
